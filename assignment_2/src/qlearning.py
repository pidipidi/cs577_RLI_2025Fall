...
class Qlearning:
    ...
    def learn(self):
        ...
        while t < self.total_steps:
            ...
            state2, reward, done, _, info = self.env.step(self.actions[action1])
    ...
    def test(self):
        ...
        while True:
            ...
            next_state, reward, done, _, info = self.env.step(self.actions[action])
            state = next_state
        ...
        self.env.unwrapped.render_value_map(self.Q, self.grid_dim[0])
